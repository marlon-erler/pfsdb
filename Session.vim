...
exe 'vert 2resize ' . ((&columns * 72 + 96) / 193)
exe 'vert 3resize ' . ((&columns * 72 + 96) / 193)
exe 'vert 4resize ' . ((&columns * 15 + 96) / 193)
argglobal
enew
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 1 + 96) / 193)
exe 'vert 2resize ' . ((&columns * 0 + 96) / 193)
exe 'vert 3resize ' . ((&columns * 171 + 96) / 193)
exe 'vert 4resize ' . ((&columns * 14 + 96) / 193)
exe 'vert 5resize ' . ((&columns * 0 + 96) / 193)
exe 'vert 6resize ' . ((&columns * 0 + 96) / 193)
exe 'vert 7resize ' . ((&columns * 1 + 96) / 193)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 31 - ((0 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 31
